...
from recurrent_ics.parsers.todo_parser import TodoParser
from recurrent_ics.serializers.todo_serializer import TodoSerializer
...
class Todo(Component):
    ...
    def __init__(self,
                 ...
                 status: str = None):
        """Instantiates a new :class:`recurrent_ics.todo.Todo`.
        ...
        Args:
            ...
            alarms (:class:`recurrent_ics.alarm.Alarm`)
            status (string)
