...
class AlarmFactory(object):
    """
    Factory class to get specific VALARM types, useful with `recurrent_ics.component.Component._from_container` method.
    """
...
class Alarm(Component):
    ...
    def __init__(self,
                 ...
                 duration=None):
        """
        Instantiates a new :class:`recurrent_ics.alarm.Alarm`.
...
class DisplayAlarm(Alarm):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """
        Instantiates a new :class:`recurrent_ics.alarm.DisplayAlarm`.

        Adheres to RFC5545 VALARM standard: http://icalendar.org/iCalendar-RFC-5545/3-6-6-alarm-component.html

        Args:
            description (string) : RFC5545 DESCRIPTION property
            kwargs (dict) : Args to :func:`recurrent_ics.alarm.Alarm.__init__`
        """
...
class AudioAlarm(Alarm):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """
        Instantiates a new :class:`recurrent_ics.alarm.AudioAlarm`.
