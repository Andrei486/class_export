...
from recurrent_ics.component import Component
from recurrent_ics.utils import (
    get_arrow,
    get_lines
)
from recurrent_ics.grammar.parse import Container

from recurrent_ics.serializers.alarm_serializer import BaseAlarmSerializer
from recurrent_ics.parsers.alarm_parser import BaseAlarmParser
...
class BaseAlarm(Component, metaclass=ABCMeta):
    ...
    def __init__(
        ...
        """
        Instantiates a new :class:`recurrent_ics.alarm.BaseAlarm`.
