...
class Timeline(object):
    def __init__(self, calendar) -> None:
        ...
        Args:
            calendar : :class:`recurrent_ics.icalendar.Calendar`
        """
        self._calendar = calendar

    def __iter__(self) -> Iterator[Event]:
        """Iterates on every event from the :class:`recurrent_ics.icalendar.Calendar` in chronological order

        Note :
            - chronological order is defined by the comparaison operators in :class:`recurrent_ics.event.Event`
    ...
    def start_after(self, instant: Arrow) -> Iterator[Event]:
        """Iterates (in chronological order) on every event from the :class:`recurrent_ics.icalendar.Calendar` in chronological order.
