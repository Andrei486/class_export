...
from recurrent_ics.grammar.parse import Container, calendar_string_to_containers
from .timeline import Timeline
from .todo import Todo
from recurrent_ics.parsers.icalendar_parser import CalendarParser
from recurrent_ics.serializers.icalendar_serializer import CalendarSerializer
...
class Calendar(Component):
            ...
            if isinstance(imports, Container):
                ...
                if len(containers) != 1:
                    raise NotImplementedError(
                        'Multiple calendars in one file are not supported by this method. Use recurrent_ics.Calendar.parse_multiple()')
    ...
    def parse_multiple(cls, string):
        ...
        and retruns a list of :class:`recurrent_ics.event.Calendar`
        """
    ...
    def __iter__(self) -> Iterable[str]:
        ...
        Example:
            ...
            >>> open('my.recurrent_ics', 'w').writelines(c)
        """
